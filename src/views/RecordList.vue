...
const totalItemsData = [
  { id: 1,  name: '60武器',       image: img('60武器.png') },
  { id: 2,  name: '70武器',       image: img('70武器.png') },
  { id: 3,  name: '80武器',       image: img('80武器.png') },
  { id: 4,  name: '60装备',       image: img('60防具.png') },
  { id: 5,  name: '70装备',       image: img('70防具.png') },
  { id: 6,  name: '80装备',       image: img('80防具.png') },
  { id: 7,  name: '特赦令牌',     image: img('特赦令牌.png') },
  { id: 8,  name: '金刚石',       image: img('金刚石.png') },
  { id: 9,  name: '定魂珠',       image: img('定魂珠.png') },
  { id: 10, name: '夜明珠',       image: img('夜明珠.png') },
  { id: 11, name: '龙鳞',         image: img('龙鳞.png') },
  { id: 12, name: '避水珠',       image: img('避水珠.png') },
  { id: 13, name: '金柳露',       image: img('金柳露.png') },
  { id: 14, name: '超级金柳露',   image: img('超级金柳露.png') },
  { id: 15, name: '净瓶玉露',     image: img('净瓶玉露.png') },
  { id: 16, name: '超级净瓶玉露', image: img('超级净瓶玉露.png') },
  { id: 17, name: '强化石',       image: img('强化石.png') },
  { id: 18, name: '摇钱树苗',     image: img('摇钱树树苗.png') },
  { id: 19, name: '海马',         image: img('海马.png') },
  { id: 20, name: '修炼果',       image: img('修炼果.png') },
  { id: 21, name: '彩果',         image: img('彩果.png') },
  { id: 22, name: '黑宝石',       image: img('黑宝石.png') },
  { id: 23, name: '红玛瑙',       image: img('红玛瑙.png') },
  { id: 24, name: '太阳石',       image: img('太阳石.png') },
  { id: 25, name: '月亮石',       image: img('月亮石.png') },
  { id: 26, name: '舍利子',       image: img('舍利子.png') },
  { id: 27, name: '光芒石',       image: img('光芒石.png') },
  { id: 29, name: '星辉石',       image: img('星辉石.png') },
  { id: 31, name: '精魄灵石',     image: img('精魄灵石.png') },
  { id: 30, name: '五色灵尘',     image: img('五色灵尘.gif') },
  { id: 34, name: '符石',         image: img('符石.png') },
  { id: 35, name: '符石卷轴',     image: img('符石卷轴.png') },
  { id: 36, name: '月华露',       image: img('月华露.png') },
  { id: 32, name: '乐器',         image: img('乐器.png') },
  { id: 33, name: '玫瑰',         image: img('玫瑰.png') },
  { id: 38, name: '金银锦盒',     image: img('金银锦盒.png') },
  { id: 39, name: '法宝任务书',   image: img('法宝任务书.png') },
  { id: 40, name: '种子',         image: img('种子.png') },
  { id: 99,  name: '金币',     image: img('金币.png') },
  { id: 100, name: '兽决',     image: img('兽决.png') },
  { id: 101, name: '高级兽决', image: img('高级兽决.gif') },
  { id: 102, name: '内丹',     image: img('内丹.png') },
  { id: 103, name: '高内丹',   image: img('高内丹.png') },
  { id: 104, name: '珍珠',     image: img('珍珠.png') },
  { id: 105, name: '附魔',     image: img('附魔.png') },
  { id: 106, name: '书',       image: img('书.png') },
  { id: 107, name: '铁',       image: img('铁.png') },
  { id: 108, name: '晶石',     image: img('晶石.png') },
  { id: 109, name: '灵饰书',   image: img('灵饰书.png') },
  { id: 110, name: '炼妖石',   image: img('炼妖石.png') },
  { id: 111, name: '图册',     image: img('图册.png') },
  { id: 112, name: '金丹',     image: img('金丹.png') },
  { id: 113, name: '如意丹',   image: img('如意丹.png') },
  { id: 114, name: '卡',       image: img('卡.png') },
  { id: 115, name: '钟灵石',   image: img('钟灵石.gif') },
  { id: 116, name: '法宝',     image: img('法宝.png') },
  { id: 117, name: '鬼谷子',   image: img('鬼谷子.png') },
