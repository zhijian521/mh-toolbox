<template>
  <div class="online-record">
    ...
    <!-- 使用帮助 -->
    <AppDialog v-model="showHelp" title="使用帮助" width="560px">
      <div class="help-content">
        <dl class="help-list">
          <dt>开始游戏</dt>
          <dd>点击后开始计时，记录在线时长和点卡消耗。切换页面不会中断计时，关闭窗口自动保存。</dd>
          <dt>角色数 / 点卡价格</dt>
          <dd>设置在线角色数量和点卡单价（梦幻币/点），影响点卡成本计算。</dd>
          <dt>物品选择</dt>
          <dd>左键已有价格的物品直接添加；左键无价格物品弹出输入框；右键任意物品可修改价格。价格单位为 W（万）。</dd>
          <dt>固定价格</dt>
          <dd>价格持久保存，下次点击直接使用。右键可随时修改。点击「导出」可分享给其他人，「导入」可批量更新价格。</dd>
          <dt>非固定价格</dt>
          <dd>每次手动输入价格，适合价格波动大的物品。最后一个「其他」还可自定义物品名称。</dd>
          <dt>今日战绩</dt>
          <dd>展示今日所有收益物品和总价值。点击 × 可移除。</dd>
          <dt>结束游戏</dt>
          <dd>停止计时并保存本次记录到历史。未点结束直接关窗口也会自动保存。</dd>
        </dl>
